<ul class="views">
    ...
    <li <?= $this->app->checkMenuSelection('ProjectDashboardController', 'show', 'StudentProjectTheme') ?>>
        <?= $this->url->icon('bar-chart', 'Tiến độ', 'ProjectDashboardController', 'show', array('project_id' => $project['id'], 'search' => $filters['search'], 'plugin' => 'StudentProjectTheme'), false, 'view-progress-dashboard') ?>
    </li>
